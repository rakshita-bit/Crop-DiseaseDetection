...
b=os.listdir("/home/rakshita/greenbeandiseased")
for cname in b:
        iname=os.listdir("/home/rakshita/greenbeandiseased/"+cname)
        for img in iname:
            print("filename",img)
            c=cv2.imread("/home/rakshita/greenbeandiseased/"+cname+"/"+img)
